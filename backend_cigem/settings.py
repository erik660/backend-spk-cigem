...
# Development helper: allow using SQLite locally by setting DEV_SQLITE=1
if os.environ.get('DEV_SQLITE', '0') == '1':
    DATABASES = {
        'default': {
...
CSRF_TRUSTED_ORIGINS = [
    'https://cigemuniverse.up.railway.app',
    'http://cigemuniverse.up.railway.app',
]